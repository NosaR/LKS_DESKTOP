...
namespace CashierRestaurant2.UserController
{
    public partial class UC_Transaksi : UserControl
    {
        ...
        private void txbTotalHarga_TextChanged(object sender, EventArgs e)
        {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            query3 = "Select count (Idpesanan) from transaksi where Idpesanan='" + txbIdPesanan.Text + "'";
